        ...
        if (cmd === 'play') {
            ...
            if (!server_queue) {
                ...
                try {
                    ...
                    video_player(message.guild, queue_constructor.songs[0], message, Discord);
                } catch (err) {
...
const video_player = async (guild, song, message, Discord) => {
    ...
    song_queue.connection.play(stream, { seek: 0, volume: 1 })
        .on('finish', () => {
            ...
            video_player(guild, song_queue.songs[0], message, Discord);
        });
